/**********************************************************************
 *
 * qsort-main-cilk.c -- Sequential and Parallel implementation of QuickSort
 *
...
int main(int argc, char **argv) {
  ...
  if(argc == 5){
    fclose(f);
    printf("File cilk_data.csv  was written successfully\n");
  }
  /* exit */
  return 0;
